...
function openNewItemForm() { editingItemId = null; $('#itemForm').reset(); $('#formTitle').textContent = 'アイテムを登録'; $('#formSubmit').textContent = '登録する'; openModal('#formModal'); }
